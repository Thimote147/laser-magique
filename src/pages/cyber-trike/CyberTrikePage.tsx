...
import about_ct from '../../assets/about_ct.jpg';

const gameModes = [
  {
    title: 'Quête Cyber',
    description: 'Embarquez pour une aventure épique à travers un royaume numérique, résolvant des énigmes et battant des ennemis cybernétiques.',
    duration: '45 minutes',
    players: '1-4 joueurs',
